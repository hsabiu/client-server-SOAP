 ...
 * 
 */
@WebServiceClient(name = "WebServerService", targetNamespace = "http://soapwebserver.habib.com/", wsdlLocation = "http://localhost:8080/WebServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVERSERVICE_QNAME = new QName("http://soapwebserver.habib.com/", "WebServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServer?wsdl");
    ...
    public WebServer getWebServerPort() {
        return super.getPort(new QName("http://soapwebserver.habib.com/", "WebServerPort"), WebServer.class);
    }
    ...
    public WebServer getWebServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapwebserver.habib.com/", "WebServerPort"), WebServer.class, features);
    }
